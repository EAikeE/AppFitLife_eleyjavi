...
| Área         | Tecnologías                                          |
| ------------ | ---------------------------------------------------- |
| App móvil    | Kotlin, Jetpack Compose, Material 3, MVVM, DataStore |
| Red          | Retrofit, Gson                                       |
...
📋 Cumplimiento de la Rúbrica (Experiencia 3)
| Indicador                            | Estado |
| ------------------------------------ | ------ |
| IE 3.1.1 – App móvil completa        | ✅      |
| IE 3.1.2 – Microservicios propios    | ✅      |
| IE 3.1.3 – Integración app ↔ backend | ✅      |
| IE 3.1.4 – Consumo API externa       | ✅      |
| IE 3.2.1 – Pruebas unitarias         | ✅      |
| IE 3.3.1 – APK firmado               | ✅      |
